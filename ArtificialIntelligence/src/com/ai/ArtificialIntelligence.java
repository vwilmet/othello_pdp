...
/**
 * Interface de gestion des différentes intelligences artificielles. </br>Cette
 * interface contient les méthodes afin d'utiliser les différentes intelligences
 * artificielles. </br>Il est important d'utiliser la méthode notifyChosenMove
 * {@link com.ai.ArtificialIntelligence#notifyChosenMove} </br>afin de signaler
 * à l'IA le coup choisit afin qu'elle positionne automatique la sentinelle au
 * bon endroit dans l'arbre. </br>L'arbre permet de prévoir les coups pour les 2
 * joueurs, il faut donc notifier à la fois le coup choisi par </br> le joueur
 * 1, mais aussi le joueur 2, qu'il soit un joueur réel ou simplement
 * l'ordinateur. </br>Par exemple : le choix de l'intelligence artficielle à
 * utiliser grâce à la fonction chooseDifficulty...
 * 
 * @author <ul>
 *         <li>Nicolas Yvon</li>
 *         </ul>
